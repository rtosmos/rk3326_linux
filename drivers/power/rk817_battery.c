...
//printk("1111111111111111power_low_off power_low_off power_low_off power_low_off\n");
	if (battery->current_avg < 0 && battery->voltage_avg < pwr_off_thresd) {
		if (!time)
			time = get_boot_sec();
printk("22222222222222power_low_off power_low_off power_low_off power_low_off\n");
		if ((base2sec(time) > MINUTE(1)) ||
			...
			pr_info("battery voltage is under %dmV, voltage_avg=%dmV, power off!\n",
				...
				printk("power_low_off power_low_off power_low_off power_low_off\n");
...
printk("6666666666666rk817_battery_probe rk817_battery_probe prk817_battery_probe \n");
